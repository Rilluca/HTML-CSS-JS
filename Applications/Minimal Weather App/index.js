const apiKey = '375be65e7f0f1ff3aa9d640d61e22124';
...
function fetchWeatherData(location) {
    ...
    fetch(apiUrl).then(response => response.json()).then(data => {
        ...
        for (const dayData of nextDaysData) {
            ...
            // Ensure the day is not duplicate and today
...
// Fetch weather data on document load for default location (Malaysia)
document.addEventListener('DOMContentLoaded', () => {
    const defaultLocation = 'Pasir Gudang';
