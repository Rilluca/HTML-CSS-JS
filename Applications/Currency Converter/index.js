...
[fromCur, toCur].forEach((select, i) => {
    for (let curCode in Country_List) {
        const selected = (i === 0 && curCode === "MYR") || (i === 1 && curCode === "USD") ? "selected" : "";
...
async function getExchangeRate() {
    ...
    try {
        const response = await fetch(`https://v6.exchangerate-api.com/v6/7393c4f539f371fd72661537/latest/${fromCur.value}`);
